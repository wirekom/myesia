                ...
                <div class="wid-body ccd">
                    <table>
                        <tr><!-- Like Count -->
                            ...
                            <td><span class="suka"><?php echo CHtml::encode($model->likeCount); ?></span></td>
                        </tr>
                    </table>
                    ...
                    <!-- Tombol Like -->
                    <?php if (!Yii::app()->user->isGuest): ?>
                        <span id="like-news" class="likeThis">
                            <?php $this->renderPartial('_ajaxLikeNewsContent', array('is_like' => $model->isLike, 'news_id' => $model->id)); ?>
                        </span>
                    <?php endif; ?>
                </div>
            </div>
