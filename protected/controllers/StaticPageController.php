...
class StaticPageController extends Controller {
    ...
    public function actionDelete($id) {
        if (Yii::app()->request->isStaticPageRequest) {
    ...
    public function loadModelSlug() {
        if (isset($_GET['slug'])) {
            if (Yii::app()->user->isGuest)
                $condition = 'status=' . StaticPage::STATUS_PUBLISHED . ' OR status=' . StaticPage::STATUS_ARCHIVED;
            else
                $condition = '';
            $model = StaticPage::model()->findByAttributes(array('slug' => $_GET['slug']), $condition);
